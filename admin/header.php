...
<div class="collapse navbar-collapse"  id="a" >
 ...
 <ul class="navbar-nav ml-auto  ">
      ...
      <li >
        <a href="employee_registration.php" class="nav-link"style="color: white;" >EMPLOYEE REGISTRATION</a>
      </li>
      <li>
        <a href="assigned_task.php" class="nav-link" style="color: white;">ASSIGNED TASK</a>
      </li>
      <li>
